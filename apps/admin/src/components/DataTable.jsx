                    ...
                    <table className="w-full min-w-[860px]">
                        <thead>
                            <tr className="border-b border-[#f2eee9] bg-[#fafaf9]">
                                {["#", "Phone", "Country", "Full Name", "Branch", "Heard Via", "Lang", "Submitted", "Actions"].map((h) => (
                                    <th
                                        key={h}
                                        className="px-4 py-3 text-left text-[10px] font-700 uppercase tracking-widest text-[#9ca3af] whitespace-nowrap"
                                    >
                                        {h}
                                    </th>
                                ))}
                      ...
                      ${i % 2 === 0 ? "bg-white" : "bg-[#fdfcfb]"}`}
                                    >
                                        ...
                                        <td className="px-4 py-3.5 max-w-[160px] overflow-hidden text-ellipsis whitespace-nowrap text-sm text-[#374151]">
                                            {row.blue_diamond_branch ?? <span className="text-[#d1d5db]">—</span>}
                                        </td>
